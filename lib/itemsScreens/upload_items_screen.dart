...
class _UploadItemsScreenState extends State<UploadItemsScreen> {
  ...
  saveBrandInfo() {
    ...
    setState(() {
      uploading = false;
      // ne treba updetovati itemUniqueId zato sto se mijenja svake sekunde
      // nece biti isti id za item u brand collection i item u sellers collection
      //itemUniqueId = DateTime.now().microsecondsSinceEpoch.toString();
    });
  ...
  validateUploadForm() async {
    if (imgXFile != null) {
      ...
      // empty text field
        ...
        Fluttertoast.showToast(msg: 'Please fill all form.');
      }
    }
